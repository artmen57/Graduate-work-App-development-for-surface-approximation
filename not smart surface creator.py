...
f1="dorsal2.pts";f_root="examples/"
f2=f_root+f1;val7=[];val8=[]
highest_pair = [];lowest_pair = [];highest_z = float("-inf");lowest_z = float("inf")
...
def reader (f2:str):
    ...
    if f1=="dorsal1.pts" or f1=="dorsal2.pts" or f1=="dorsal7.pts"or f1=="dorsal9.pts":
    ...
    elif f1=="dorsal3.pts" or f1=="dorsal4.pts" or f1=="dorsal5.pts" or f1=="dorsal11.pts" or f1=="dorsal12.pts":
...
lin_vals, uv_vals=reader(f2)
obj=surface_gen(lin_vals, uv_vals)
renderer(obj)
